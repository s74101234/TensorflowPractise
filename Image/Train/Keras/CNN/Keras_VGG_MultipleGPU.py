...
def buildVGG13Model(img_height,img_width,img_channl,num_classes,num_GPU):
    ...
    model.add(Conv2D(64,(3,3),strides=(1,1),input_shape=(img_height, img_width,img_channl),padding='same',activation='relu'))
...
if __name__ == "__main__":
    ...
    dataSplitRatio=0.8
    readDataPath = "./../../../Data/"
    saveModelPath = "./../../../Model/Keras_VGG"
    saveTensorBoardPath = "./../../../Model/TensorBoard"
    writeLabelPath = "./../../../Model/Keras_VGG_Classes.txt"
    num_GPU = 2
    num_DataAug = 0
    ...
    # model = buildVGG13Model(img_height,img_width,img_channl,num_classes,num_GPU)
    model = buildVGG16Model(img_height,img_width,img_channl,num_classes,num_GPU)
