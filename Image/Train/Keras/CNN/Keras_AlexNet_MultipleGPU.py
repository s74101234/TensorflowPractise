...
def buildAlexNetModel(img_height,img_width,img_channl,num_classes,num_GPU):
    ...
    model.add(Conv2D(96,(11,11),strides=(4,4),input_shape=(img_height, img_width,img_channl),padding='valid',activation='relu'))
...
if __name__ == "__main__":
    #參數設定
    img_height, img_width, img_channl = 227,227,1 #227, 227 , 3
    num_classes = 10
    batch_size = 32
    epochs = 100
    dataSplitRatio=0.8
    readDataPath = "./../../../Data/"
    saveModelPath = "./../../../Model/Keras_Alex"
    saveTensorBoardPath = "./../../../Model/TensorBoard"
    writeLabelPath = "./../../../Model/Keras_Alex_Classes.txt"
    num_GPU = 2
    num_DataAug = 0
