...
def buildVGG19Model(img_channl,img_height,img_width,num_classes):
    #建立模型,(LeNet架構)
    model = Sequential()
    
    model.add(Convolution2D(64, (3, 3), activation='relu', input_shape = (img_height, img_width,img_channl),padding='same'))
...
if __name__ == "__main__":
    ...
    saveModelPath = "./trainModels/Keras_VGG19"
    ...
    model = buildVGG19Model(img_channl,img_height,img_width,num_classes)
