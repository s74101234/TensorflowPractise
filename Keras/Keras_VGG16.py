...
def buildVGG16Model(img_channl,img_height,img_width,num_classes):
    #建立模型,(LeNet架構)
    model = Sequential()
...
if __name__ == "__main__":
    ...
    saveModelPath = "./trainModels/Keras_VGG16"
    ...
    model = buildVGG16Model(img_channl,img_height,img_width,num_classes)
